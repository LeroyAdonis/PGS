                        ...
                        {mockAnalytics.platformStats.map((platform) => (
                            <div key={platform.platform} className="flex items-center justify-between p-4 border rounded-lg">
                                <div className="flex items-center gap-4">
                                    <div className={`w-3 h-3 rounded-full ${platformColors[platform.platform as keyof typeof platformColors]}`} />
                                    <div>
                                ...
                                <div className="text-right">
                                    ...
                                    <div className="text-sm text-muted-foreground">{platform.engagement} engagements</div>
