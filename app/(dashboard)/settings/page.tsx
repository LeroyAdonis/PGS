    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Connect your social media accounts to publish content automatically. You can connect up
            to {accounts.filter((acc) => acc.connection_status === 'connected').length}/4 accounts
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 border rounded-lg">
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Manage your billing and upgrade your plan
                </div>
              </div>
